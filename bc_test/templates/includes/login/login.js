...
login.bind_events = function () {
    ...
    window.onload = function() {
		...
		if (pageContent) {
			pageContent.style.backgroundImage = 'url("files/Biz C banner.png")';
			pageContent.style.backgroundSize = 'cover'; // Optional: to cover the entire element
			pageContent.style.backgroundPosition = 'center'; // Optional: to center the image
		}
        var pageCard = document.querySelector('.page-card');
        pageCard.style.marginLeft = '5px';
