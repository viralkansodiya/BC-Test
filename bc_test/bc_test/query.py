...
class ProductQuery:
	...
	def build_item_group_filters(self, item_group):
		...
		item_group_filters.append(["Website Item", "custom_parent_item_group", "=", item_group])
		...
		if frappe.db.get_value("Item Group", item_group, "include_descendants"):
			...
			item_group_filters.append(["Website Item", "custom_parent_item_group", "in", include_groups])
